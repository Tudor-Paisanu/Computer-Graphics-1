...
int main() {
	...
	// scene.add_object(std::make_shared<Sphere>(Vector(0, 0, 0), 10, Vector(0.8, 0.8, 0.8)));
	scene.add_object(cat);
	scene.add_object(std::make_shared<Sphere>(Vector(0, 0, 1000), 940,  Vector(0.9, 0.2, 0.9)));
